...
```bash
reqstool status local -p {root_of_project}/docs/requirements
```

If you would like to generate your requirement data as a asciidoc report file, you could run 

```bash
reqstool report-asciidoc local -p {root_of_project}/docs/requirements -o {path-to-file}filename.adoc
```

If you would like to generate your requirement data as a json file, you could run 

```bash
reqstool generate-json local -p {root_of_project}/docs/requirements -o {path-to-file}filename.adoc
```
